  ...
  const handlePayment = async () => {
    try {
      ...
      var options = {
        ...
        amount: orderAmount * 100, // Amount is in currency subunits. Default currency is INR. Hence, 50 refers to 50 paise not 50 rupees
        currency: "INR",
        name: "ShoppyGlobe",
        description: "Shoppy-Globe",
        ...
        prefill: {
          ...
          contact: "100100100100",
        },
        notes: {
          address: "VPO Tharial, Pathankot",
        },
        theme: {
          color: "#3399cc",
        },
  ...
  return (
    <>
      <div className="container  my-3">
        <h1 className="text-center text-black">Order Summary</h1>
